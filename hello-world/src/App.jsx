...
@keyframes spin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
  ...
  // 🔹 Nya hjälpare: markera alla / avmarkera alla
  function selectAllVisible() {
    setSelectedSwimmers(new Set(filteredSwimmers.map(s => s.name)));
  }
  ...
  function generateTeams() {
    ...
    if (reqKeys.length === 1 && reqKeys[0].startsWith("frisim")) {
      ...
      // MIX: alltid 2 damer + 2 herrar per lag
      if (requireMix) {
              ...
              <div style={{ ...cardBox, marginTop: 12 }}>
                ...
                <div style={{ display: "flex", gap: 8, marginBottom: 8, flexWrap: "wrap" }}>
                  <button
                    ...
                    title="Markera alla simmare i den filtrerade listan"
                  >
                    Markera alla
                  </button>
                  <button
